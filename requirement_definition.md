...
## 概要
### アプリケーション概要
bf16形式の正方行列に対する行列積和計算を行います。
複数の行列サイズに対して、単一プロセス実行での実行時間を測定します。
最大サイズは10000*10000とします。

### 最適化アプローチ
sbgemm.cプログラムのsbgemm_nolib関数を高速化します。
OpenBLAS、MKL、reference.pdfに記載された実装を参考にして良い。
